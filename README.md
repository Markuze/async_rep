...
This README is the concise feasibility argument. The detailed architecture
proposal is [`live_ceph_async_replication_v2.rst`](live_ceph_async_replication_v2.rst).
